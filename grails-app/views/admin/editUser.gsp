...
<html>
	...
	<body>
		...
		<div class="container" role="main">
			...
			<div>
				<g:form class="form-horizontal" url="[controller:'admin', action:'updateUser', params:[id:user.id]]"  autocomplete="off">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="email" id="email" name="email" value="${user.username}" class="span5">
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
								<input type="submit" class="btn btn-primary" value="Update">
								<g:link class="btn" controller="admin" action="users">Cancel</g:link>
							</div>
						</div>
					</fieldset>
				</g:form>
