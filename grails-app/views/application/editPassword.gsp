...
<html>
	...
	<body>
		...
		<div class="container" role="main">
			...
			<div>
				<g:form class="form-horizontal" url="[controller:'application', action:'updatePassword', params:[id:user.id]]"  autocomplete="off">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="password" id="currentPassword" name="currentPassword" value="" class="span5" required>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="newPassword">New Password</label>
							<div class="controls">
								<input type="password" id="newPassword" name="newPassword" value="" class="span5" required>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="newPassword2">Re-enter Password</label>
							<div class="controls">
								<input type="password" id="newPassword2" name="newPassword2" value="" class="span5" required>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
