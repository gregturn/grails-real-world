...
<html>
	...
	<body>
		...
		<div class="container" role="main">
			...
			<div>
				<g:form class="form-horizontal" url="[controller:'application', action:'updateEmail', params:[id:user.id]]"  autocomplete="off">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="email" id="email" name="email" value="${user.username}" class="span5" required>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="email2">Re-enter Email</label>
							<div class="controls">
								<input type="email" id="email2" name="email2" value="" class="span5" required>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
